        ...
        <form>
         <h2>Forgot Password</h2>
          ...
          <input style={{borderRadius:"7px"}}
            ...
            required
          />
          <button style={{marginLeft:"20%"}} className="btn btn-success" onClick={sendOTP}>
            Send OTP
         ...
         <label>Enter OTP : </label>
          ...
          required
        />  
        <button style={{marginLeft:"20%"}} className="btn btn-success" onClick={handleOnChangeOTP}>
            Verify
          </button>
         ...
         <label>Confirm Password : </label>
          <input
            ...
            required
          />{" "} <i onClick={handleClickShowPassword}>{ showPassword ?eyeSlash:eye}</i>
         <div className="text-danger" style={{fontSize:"15px"}}> {error} </div> 
          <br />

          <button style={{marginLeft:"20%"}} className="btn btn-success" onClick={updatePassword}>
      Update Password
      {load2 && <Spinner animation="border" variant="primary">
        </Spinner>}
