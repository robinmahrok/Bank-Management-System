...
export default function DepositMoney() {
  ...
  const handleOnChangeYesWithdrawMoney = (e) => {
    ...
    axios
      .post(baseUrl + "/withdrawMoney", data)
      .then((response) => {
        setLoad(false);
    ...
    <div className="App">
          ...
          <form>
            ...
            <div>
              ...
              <button
                ...
                onClick={handleOnChangeWithdrawMoney}
              >
                Withdraw Money
                {load && (
      ...
      {prompt && (
        <Modal show={prompt} onHide={handleOnChangeNoWithdrawMoney}>
          ...
          <Modal.Body>
            Are you sure you want to Withdraw Rs.{amount} in your account?
          </Modal.Body>
          <Modal.Footer>
            <button
              className="btn btn-secondary"
              onClick={handleOnChangeNoWithdrawMoney}
            >
              No
            </button>
            <button
              className="btn btn-primary"
              onClick={handleOnChangeYesWithdrawMoney}
            >
              Withdraw
            </button>
          </Modal.Footer>
