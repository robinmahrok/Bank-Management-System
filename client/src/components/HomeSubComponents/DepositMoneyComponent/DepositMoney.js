    ...
    <div className="App">
          ...
          <form>
            ...
            <div>
              ...
              <button
                ...
                onClick={handleOnChangeDepositMoney}
              >
                Deposit Money
              </button>
            </div>
      ...
      {prompt && (
        <Modal show={prompt} onHide={handleOnChangeNoDepositMoney}>
          ...
          <Modal.Body>
            Are you sure you want to deposit Rs.{amount} in your account?
          </Modal.Body>
          <Modal.Footer>
            <button
              className="btn btn-secondary"
              onClick={handleOnChangeNoDepositMoney}
            >
              No
            </button>
            <button
              className="btn btn-primary"
              onClick={handleOnChangeYesDepositMoney}
            >
              Deposit
            </button>
          </Modal.Footer>
