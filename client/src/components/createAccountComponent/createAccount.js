...
<div>
<label>Email :&nbsp;</label>
    <input type="text" style={{ borderRadius: "7px" }} onChange={handleOnChangeEmail}/>

  { getDetails &&
  <div>
  
        <button style={{marginLeft:"20px"}} className="btn btn-info" onClick={GetDetails}>Get Your Details</button>
      </div>
     }
</div>
    {showDetails && <div>
      ...
      <label>Name : </label>
            ...
            <br />
            <div>
        <button style={{marginLeft:"20px"}} className="btn btn-success" onClick={handleOnChangeCreateAccount}>Create Account</button>
